...
console.log(diagnosis);
  ...
  return (
    ...
    <p className="font-semibold"> Date: {!diagnosis ? 'N/A' : new Date(diagnosis.createdAt).toDateString()}</p>
    ...
    <div className="grid-body">
      {isLoading ? (
        ...
        diagnosis && diagnosis.PatientDiagnoses && diagnosis.PatientDiagnoses.length &&
