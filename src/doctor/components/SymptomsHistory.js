...
function SymptomsHistory({ user, sessionId }) {
  ...
  return (
    ...
    <p className="font-semibold"> Date: {!symptoms ? 'N/A' : new Date(symptoms.createdAt).toDateString()}</p>
    ...
    <div className="grid-body">
      {isLoading ? (
        ...
        symptoms && symptoms.PatientSymptoms && symptoms.PatientSymptoms.length &&
